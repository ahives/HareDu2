        ...
        public async Task Should_be_able_to_get_all_definitions()
        {
            ...
            if (result.HasData)
            {
                ...
                foreach (var queue in result.Data.Queues)
                {
                    ...
                    Console.WriteLine((string) "TotalMessageBytesPagedOut: {0}", (object) queue.TotalMessageBytesPagedOut);
                    ...
                    Console.WriteLine((string) "RateOfReductions: {0}", (object) queue.RateOfReductions?.Rate);
                    Console.WriteLine((string) "RateOfMessagesUnacknowledged: {0}", (object) queue.RateOfUnacknowledgedMessages?.Rate);
                    Console.WriteLine((string) "RateOfMessagesReady: {0}", (object) queue.RateOfReadyMessages?.Rate);
                    Console.WriteLine((string) "RateOfMessage: {0}", (object) queue.RateOfMessages?.Rate);
