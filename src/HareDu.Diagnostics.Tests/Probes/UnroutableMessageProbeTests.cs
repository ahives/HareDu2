...
namespace HareDu.Diagnostics.Tests.Probes
{
    ...
    public class UnroutableMessageProbeTests
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new UnroutableMessageProbe(config.Diagnostics, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(UnroutableMessageProbe).GetIdentifier());
        }
