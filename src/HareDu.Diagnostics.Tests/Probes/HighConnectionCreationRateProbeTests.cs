...
namespace HareDu.Diagnostics.Tests.Probes
{
    ...
    public class HighConnectionCreationRateProbeTests
    {
        ...
        public void Verify_analyzer_yellow_condition_1()
        {
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(HighConnectionCreationRateProbe).GetIdentifier());
        }
        ...
        {
            var knowledgeBaseProvider = _container.Resolve<IKnowledgeBaseProvider>();
            var analyzer = new HighConnectionCreationRateProbe(null, knowledgeBaseProvider);
