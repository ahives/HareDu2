...
namespace HareDu.Diagnostics.Tests.Probes
{
    ...
    public class AvailableCoresProbeTests
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new AvailableCpuCoresProbe(config.Diagnostics, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(AvailableCpuCoresProbe).GetIdentifier());
        }
