...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    [TestFixture]
    public class RuntimeProcessLimitAnalyzerTests
    {
        ...
        public void Verify_sensor_red_condition_1()
        {
            ...
            var sensor = new RuntimeProcessLimitAnalyzer(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(RuntimeProcessLimitAnalyzer).GenerateIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
