...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    [TestFixture]
    public class UnroutableMessageAnalyzerTests
    {
        ...
        public void Verify_sensor_red_condition()
        {
            ...
            var sensor = new UnroutableMessageAnalyzer(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(UnroutableMessageAnalyzer).GenerateIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
