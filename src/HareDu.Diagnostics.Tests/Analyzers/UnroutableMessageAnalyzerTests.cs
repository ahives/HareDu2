...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class UnroutableMessageAnalyzerTests
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new UnroutableMessageAnalyzer(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(UnroutableMessageAnalyzer).GetIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
