...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class UnroutableMessageAnalyzerTests
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new UnroutableMessageAnalyzer(config.Analyzer, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(UnroutableMessageAnalyzer).GetIdentifier());
        }
