...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class ChannelThrottlingAnalyzerTests
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new ChannelThrottlingAnalyzer(config.Analyzer, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(ChannelThrottlingAnalyzer).GetIdentifier());
        }
