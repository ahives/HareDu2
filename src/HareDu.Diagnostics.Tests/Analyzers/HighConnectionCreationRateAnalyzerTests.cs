...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    [TestFixture]
    public class HighConnectionCreationRateAnalyzerTests
    {
        ...
        public void Verify_analyzer_yellow_condition_1()
        {
            ...
            var analyzer = new HighConnectionCreationRateAnalyzer(config.Analyzer, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(HighConnectionCreationRateAnalyzer).GetIdentifier());
        }
        ...
        {
            var knowledgeBaseProvider = _container.Resolve<IKnowledgeBaseProvider>();
            var analyzer = new HighConnectionCreationRateAnalyzer(null, knowledgeBaseProvider);
