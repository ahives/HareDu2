...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class QueueNoFlowAnalyzerTests
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new QueueNoFlowAnalyzer(config.Analyzer, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(QueueNoFlowAnalyzer).GetIdentifier());
        }
