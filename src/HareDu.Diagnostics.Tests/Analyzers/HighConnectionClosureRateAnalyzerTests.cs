...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    [TestFixture]
    public class HighConnectionClosureRateAnalyzerTests
    {
        ...
        public void Verify_sensor_yellow_condition_1()
        {
            ...
            var sensor = new HighConnectionClosureRateAnalyzer(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(HighConnectionClosureRateAnalyzer).GenerateIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
