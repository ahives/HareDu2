...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class MessagePagingAnalyzerTests
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new MessagePagingAnalyzer(config.Analyzer, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(MessagePagingAnalyzer).GetIdentifier());
        }
