...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class MessagePagingAnalyzerTests
    {
        ...
        public void Verify_sensor_red_condition()
        {
            ...
            var sensor = new MessagePagingAnalyzer(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(MessagePagingAnalyzer).GenerateIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
