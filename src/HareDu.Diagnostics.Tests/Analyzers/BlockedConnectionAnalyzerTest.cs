...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    [TestFixture]
    public class BlockedConnectionAnalyzerTest
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new BlockedConnectionAnalyzer(config.Analyzer, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(BlockedConnectionAnalyzer).GetIdentifier());
        }
