...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class ConsumerUtilizationAnalyzerTests
    {
        ...
        public void Verify_analyzer_yellow_condition()
        {
            ...
            var analyzer = new ConsumerUtilizationAnalyzer(config.Analyzer, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(ConsumerUtilizationAnalyzer).GetIdentifier());
        }
