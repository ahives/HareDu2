...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class SocketDescriptorThrottlingAnalyzerTests
    {
        ...
        public void Verify_sensor_yellow_condition()
        {
            ...
            var sensor = new SocketDescriptorThrottlingAnalyzer(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(SocketDescriptorThrottlingAnalyzer).GenerateIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
