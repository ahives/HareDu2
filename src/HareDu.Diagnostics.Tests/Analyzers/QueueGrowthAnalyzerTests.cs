...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class QueueGrowthAnalyzerTests
    {
        ...
        public void Verify_analyzer_yellow_condition()
        {
            ...
            var analyzer = new QueueGrowthAnalyzer(config.Analyzer, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(QueueGrowthAnalyzer).GetIdentifier());
        }
