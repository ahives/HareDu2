...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class AvailableCoresAnalyzerTests
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new AvailableCpuCoresAnalyzer(config.Analyzer, knowledgeBaseProvider);
            ...
            result.KnowledgeBaseArticle.Identifier.ShouldBe(typeof(AvailableCpuCoresAnalyzer).GetIdentifier());
        }
