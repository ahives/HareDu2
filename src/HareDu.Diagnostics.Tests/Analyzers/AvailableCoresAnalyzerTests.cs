...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    public class AvailableCoresAnalyzerTests
    {
        ...
        public void Verify_analyzer_red_condition()
        {
            ...
            var analyzer = new AvailableCpuCoresAnalyzer(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(AvailableCpuCoresAnalyzer).GetIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
