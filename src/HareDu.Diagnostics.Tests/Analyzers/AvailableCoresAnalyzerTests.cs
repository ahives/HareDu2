...
namespace HareDu.Diagnostics.Tests.Analyzers
{
    ...
    [TestFixture]
    public class AvailableCoresAnalyzerTests
    {
        ...
        public void Verify_sensor_red_condition()
        {
            ...
            var sensor = new AvailableCpuCoresAnalyzer(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(AvailableCpuCoresAnalyzer).GenerateIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
