...
namespace HareDu.Diagnostics.Tests.Sensors
{
    ...
    [TestFixture]
    public class MessagePagingSensorTests
    {
        ...
        public void Verify_sensor_red_condition()
        {
            ...
            var sensor = new MessagePagingSensor(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(MessagePagingSensor).FullName.GenerateIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
