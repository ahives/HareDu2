...
namespace HareDu.Diagnostics.Tests.Sensors
{
    ...
    [TestFixture]
    public class UnroutableMessageSensorTests
    {
        ...
        public void Verify_sensor_red_condition()
        {
            ...
            var sensor = new UnroutableMessageSensor(configProvider, knowledgeBaseProvider);
            ...
            Assert.AreEqual(typeof(UnroutableMessageSensor).FullName.GenerateIdentifier(), result.KnowledgeBaseArticle.Identifier);
        }
