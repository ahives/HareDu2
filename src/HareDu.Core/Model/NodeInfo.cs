...
namespace HareDu.Core.Model
{
    ...
    public interface NodeInfo
    {
        ...
        GarbageCollectedDetails GarbageCollectedDetails { get; }
    ...
    public interface FreeDiskSpaceDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }

    public interface GarbageCollectedDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }

    public interface ReclaimedBytesFromGCDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }

    public interface ContextSwitchDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }
    ...
    public interface IOBytesReadDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }

    public interface AvgIOReadTimeDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }

    public interface IOWriteBytesDetail
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }
    ...
    public interface AvgIOSyncTimeDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }

    public interface AvgIOSeekTimeDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }

    public interface AvgTimePerIOWriteDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }
    ...
    public interface IOWriteDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }
    ...
    public interface IOFileHandleOpenAttemptAvgTimeDetails
    {
        [JsonProperty("rate")]
        decimal Rate { get; }
    }
