...
namespace HareDu.Internal.Serialization
{
    ...
    public static class TypeCache
    {
        ...
        internal static readonly IObjectConverterCache ObjectConverterCache =
            new DynamicObjectConverterCache(Cached.Builder);
        ...
        ITypeCache<T>
    {
        ...
        T ITypeCache<T>.InitializeFromObject(object values)
        {
            ...
            IDictionary<string, object> dictionary =
                TypeCache.DictionaryConverterCache.GetConverter(values.GetType()).GetDictionary(values);
