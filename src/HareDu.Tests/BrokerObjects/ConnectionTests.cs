...
namespace HareDu.Tests.BrokerObjects
{
        ...
        HareDuTesting
    {
        ...
        public async Task Test()
        {
            ...
            result.Data[0].RateOfPacketBytesReceived.ShouldNotBeNull();
            result.Data[0].RateOfPacketBytesReceived?.Rate.ShouldBe(0.0M);
            result.Data[0].PacketsSent.ShouldBe<ulong>(3);
            result.Data[0].PacketBytesSent.ShouldBe<ulong>(542);
            result.Data[0].RateOfPacketBytesSent.ShouldNotBeNull();
            result.Data[0].RateOfPacketBytesSent?.Rate.ShouldBe(0.0M);
            result.Data[0].TotalReductions.ShouldBe<ulong>(5956);
            result.Data[0].RateOfReduction.ShouldNotBeNull();
            result.Data[0].RateOfReduction?.Rate.ShouldBe(0.0M);
