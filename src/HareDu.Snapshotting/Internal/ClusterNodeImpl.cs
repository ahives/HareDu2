...
namespace HareDu.Snapshotting.Internal
{
        ...
        ClusterNode
    {
        ...
        public SnapshotTimeline<NodeSnapshot> History => _timeline.Value;
        ...
        public SnapshotLens<NodeSnapshot> TakeSnapshot(CancellationToken cancellationToken = default)
        {
        ...
        public SnapshotLens<NodeSnapshot> RegisterObserver(IObserver<SnapshotContext<NodeSnapshot>> observer) => throw new NotImplementedException();

        public SnapshotLens<NodeSnapshot> RegisterObservers(IReadOnlyList<IObserver<SnapshotContext<NodeSnapshot>>> observers) => throw new NotImplementedException();
