...
namespace HareDu.Diagnostics.Analyzers
{
        ...
        IDiagnosticAnalyzer
    {
        ...
        public UnlimitedPrefetchCountAnalyzer(IDiagnosticScannerConfigProvider configProvider, IKnowledgeBaseProvider knowledgeBaseProvider)
        ...
        public DiagnosticResult Execute<T>(T snapshot)
        {
            ...
            if (data.PrefetchCount == 0)
            {
                ...
                result = new WarningDiagnosticResult(data.ConnectionIdentifier,
                    data.Identifier,
                    Identifier,
                    ComponentType,
                    analyzerData,
            ...
            else
            {
                ...
                result = new InconclusiveDiagnosticResult(data.ConnectionIdentifier,
                    data.Identifier,
                    Identifier,
                    ComponentType,
                    analyzerData,
