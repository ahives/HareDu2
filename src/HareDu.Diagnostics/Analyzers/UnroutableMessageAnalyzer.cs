...
namespace HareDu.Diagnostics.Analyzers
{
        ...
        IDiagnosticAnalyzer
    {
        ...
        public UnroutableMessageAnalyzer(DiagnosticAnalyzerConfig config, IKnowledgeBaseProvider knowledgeBaseProvider)
        ...
        public DiagnosticAnalyzerResult Execute<T>(T snapshot)
        {
            ...
            if (data.Churn.NotRouted.Total > 0)
            {
                ...
                result = new NegativeDiagnosticAnalyzerResult(data.ClusterName,
                    null,
                    Identifier,
                    ComponentType,
                    analyzerData,
            ...
            else
            {
                ...
                result = new PositiveDiagnosticAnalyzerResult(data.ClusterName,
                    null,
                    Identifier,
                    ComponentType,
                    analyzerData,
