...
namespace HareDu.Diagnostics.Internal
{
    ...
    class WarningDiagnosticProbeResult :
        DiagnosticProbeResult
    {
        public WarningDiagnosticProbeResult(string parentComponentIdentifier, string componentIdentifier, string analyzerIdentifier,
