...
namespace HareDu.Diagnostics.Internal
{
    ...
    class NegativeDiagnosticProbeResult :
        DiagnosticProbeResult
    {
        public NegativeDiagnosticProbeResult(string parentComponentIdentifier, string componentIdentifier, string analyzerIdentifier,
